...
<head>
    ...
    <title>CraftVibe - Preserving Culture, Supporting Artists</title>
    ...
    <style>
        ...
        * {
        ...
        /* Hero Section */
        .hero {
            background-image: url('logos/bg1.png');
        ...
        <nav class="navbar">
            <div class="nav-container">
                <a href="#home" class="logo">
                    <img src="logos/logo.jpg" alt="CraftVibe Logo">
                    <div class="logo-text">
                        <h1>CraftVibe</h1>
...
<div class="nav-actions">
    <?php if (isset($_SESSION['user_id'])): ?>
        ...
        <?php if ($_SESSION['user_role'] === 'admin'): ?>
            <a href="admin_users.php" class="btn btn-outline">Admin Panel</a>
        <?php elseif ($_SESSION['user_role'] === 'supplier'): ?>
            <a href="supplier.php" class="btn btn-outline">Supplier Panel</a>
        <?php endif; ?>
        ...
        <div class="container">
            <div class="about-content">
                ...
                <div class="about-image">
                    <img src="logos/about.jpg" alt="Tribal Artisans">
                </div>
            </div>
        </div>
    </section>
