...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || empty($password)) {
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            echo "<!-- Password in DB: " . htmlspecialchars($user['password']) . " -->";
            ...
            if (password_verify($password, $user['password'])) {
                ...
                // Password is correct (plain text - for migration)
                // Hash the password for security
                $hashedPassword = password_hash($password, PASSWORD_DEFAULT);
                $updateQuery = "UPDATE users SET password = '$hashedPassword' WHERE id = {$user['id']}";
...
<body>
    <div class="login-container">
        ...
        <div class="demo-accounts">
            <h3>Demo Accounts:</h3>
            <div class="demo-account"><strong>Admin:</strong> admin@artisanark.com / admin123</div>
            <div class="demo-account"><strong>Supplier:</strong> supplier@artisanark.com / supplier123</div>
            <div class="demo-account"><strong>Customer:</strong> customer@artisanark.com / customer123</div>
        </div>
    </div>
